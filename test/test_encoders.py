...
def test_mem_encoder_trains_without_exception():
    ...
    SPE = 10
    print(f"cumloss={[t/SPE for t in train_memory(me, X, Xnoise, SPE, loss_fn, opt)]}")


# @pytest.mark.train
# def test_mem_encoder_benchmark():
#     MEM_SIZE=100
#     me = MemoryEncoder(3, [200, 200], memory_size=MEM_SIZE, memory_length=10)
